...
/// <summary>
/// CPU module for gauge-invariant topology operations.
/// 
...
/// 
/// 1. Checks if an edge carries non-trivial flux
...
/// 
/// Based on original GaugeAwareTopology implementation.
/// </summary>
public sealed class GaugeAwareTopologyCpuModule : CpuPluginBase
{
    /// <summary>
    ...
    /// </summary>
    public double TrivialPhaseThreshold { get; set; } = 0.1; // ~6 degrees

    public override string Name => "Gauge-Aware Topology (CPU)";
    public override string Description => "CPU-based gauge-invariant topology operations with flux conservation";
    public override string Category => "Gauge";
    public override int Priority => 25;

    public override void Initialize(RQGraph graph)
    {
        // Ensure edge phases are initialized (use 2D matrix property)
    ...
    {
        // This module provides utility methods for topology operations
        // Actual topology changes are driven by other modules (MCMC, etc.)
        // No active evolution in ExecuteStep - this is a service module
    }
    ...
    /// </summary>
    public bool CanRemoveEdgeSafely(RQGraph graph, int i, int j, out int alternatePathLength)
    {
    ...
    /// </summary>
    public bool RemoveEdgeWithFluxRedistribution(RQGraph graph, int i, int j, out double releasedEnergy)
    {
        releasedEnergy = 0.0;
    ...
    /// </summary>
    public double ComputeEdgeFlux(RQGraph graph, int i, int j)
    {
        ArgumentNullException.ThrowIfNull(graph);
    ...
    /// </summary>
    public bool WouldCreateTopologicalDefect(RQGraph graph, int i, int j)
    {
