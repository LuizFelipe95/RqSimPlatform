namespace RqSimTelemetryForm.Helpers;

/// <summary>
/// Fast GDI+ chart rendering using pre-decimated array data.
/// Adapted from RqSimUI.Helpers.ChartRenderer.
/// </summary>
public static class ChartRenderer
{
    ...
    /// <summary>
    /// Fast line chart drawing for int[] values.
    /// </summary>
    public static void DrawSimpleLineChartFast(Graphics g, int width, int height, int[] xSteps, int[] values, string title, Color color)
    {
        ...
        {
            g.DrawString(NoDataText, new Font("Arial", 10), Brushes.Gray, 10, 10);
            return;
        }
    ...
    /// <summary>
    /// Fast line chart drawing for double[] values.
    /// </summary>
    ...
    /// <summary>
    /// Dual-axis line chart for overlaying two time series (e.g., Energy vs Temperature).
    /// </summary>
    public static void DrawDualLineChartFast(Graphics g, int width, int height, int[] xSteps,
        double[] primaryValues, double[] secondaryValues,
        string title, Color primaryColor, Color secondaryColor)
    {
        ...
        g.DrawString(maxY2.ToString("F2"), labelFont, secondaryBrush, width - marginRight + 5, marginTop - 5);
        g.DrawString(minY2.ToString("F2"), labelFont, secondaryBrush, width - marginRight + 5, marginTop + plotHeight - 12);
